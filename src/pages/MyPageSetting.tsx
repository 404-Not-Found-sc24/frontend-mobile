      ...
      <div className="w-full flex items-center flex-col">
        ...
        <div>
          <div className="flex flex-col">
            ...
            <div className="flex">
              <button
                className="text-main-green-color text-sm underline mt-1 p-2"
                onClick={naviChangePassword}
              >
                비밀번호 변경
              </button>
              <div className="text-main-green-color text-sm underline mt-1 p-2">
                |
              </div>
              <button
                className="text-main-green-color text-sm underline mt-1 p-2"
        ...
        <button
          className="my-2 bg-main-red-color opacity-75 rounded text-white py-1 px-3 font-BMJUA"
